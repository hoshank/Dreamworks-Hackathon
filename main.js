...
function createParticles(){
    ...
    //var material = THREE.ImageUtils.loadTexture('./particle.png');
    var material = new THREE.ParticleBasicMaterial({size: 0.5 ,
   color: 0xffff00, map: THREE.ImageUtils.loadTexture(
	    "assets/particle.png"
	  ),blending: THREE.AdditiveBlending,transparency:true
	   });

    for (var x = 0; x < particleCount; x++) {
            var particle = new THREE.Vector3(Math.random() , 1.25 ,  Math.random());
